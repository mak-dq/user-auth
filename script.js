...
function showDetails(user) {
  ...
  document.getElementById("user-details-heading").innerHTML =
    loggedInUser.username === user.username ? "Your details" : "User details";
  ...
  users.forEach((user) => {
    ...
    if (user.username === loggedInUser.username) {
      userElement.innerHTML = `
                <td class="self-block">${i}</td>
                <td class="self-block">${user.email}</td>
                <td class="self-block">${user.username}</td>
                <td class="self-block">${user.firstname}</td>
                <td class="self-block">${user.lastname}</td>
                <td class="self-block">${user.gender}</td>
                <td class="self-block">${user.department}</td>
      `;
    } else {
      userElement.innerHTML = `
